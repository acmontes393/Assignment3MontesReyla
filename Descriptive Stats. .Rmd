---
title: "A meta-analysis of the effects of internet and mobile usage on migration"
...
```{r merged90, tidy=TRUE, warning=FALSE, comment="Note:", cache=FALSE, eval=TRUE, results="axis", message=FALSE}
# Graphs
# 1990
...
Emi90 <- mapCountryData(sPDF, nameColumnToPlot='emigrationpercap', 
                        mapTitle= 'Figure 1. Number of emigrants per capita 1990', 
...
sPDFII <- joinCountryData2Map( merged00
                             ,joinCode = "ISO2"
                             ,nameJoinColumn = "iso2c")
mapCountryData(sPDFII, nameColumnToPlot='emigrationpercap', mapTitle= 'Figure 2. Number of emigrants per capita 2000',
               colourPalette = c("darkorange", "coral2","gold","aquamarine1", "cyan3", "blue","magenta"),
               borderCol='black', missingCountryCol="beige")
...
sPDFIII <- joinCountryData2Map( merged10
                                ,joinCode = "ISO2"
                                ,nameJoinColumn = "iso2c")
mapCountryData(sPDFIII, nameColumnToPlot='emigrationpercap', mapTitle= 'Figure 3. Number of emigrants per capita 2010',
               colourPalette = c("darkorange", "coral2","gold","aquamarine1", "cyan3", "blue","magenta"),
               borderCol='black', missingCountryCol="beige")
...
sPDFIV <- joinCountryData2Map( merged13
                               ,joinCode = "ISO2"
                               ,nameJoinColumn = "iso2c")
mapCountryData(sPDFIV, nameColumnToPlot='emigrationpercap', mapTitle= 'Figure 4. Number of emigrants per capita 2013',
               colourPalette = c("darkorange", "coral2","gold","aquamarine1", "cyan3", "blue","magenta"),
               borderCol='black', missingCountryCol="beige")
