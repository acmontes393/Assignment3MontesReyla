...
Table 1 illustrates the regression results of a *panel regression*. The results show that cellphone usage is significant to explain the changse in immigration inside a country. Additionally, the within estimations indicates that cellphone users do not explain the imigration pattern accross countries. 

when we compare in the smame country within years, the more cellphone users the more migration will be.
comparing between country, there is no effect on cellphone users. 

Its the effect within the country and the year. More technology is indroduced in the country, the more it will incentiize or "push" immigration in the country. 

While the differences accross the countries are not a relevant factor to explain immgration accross countries. 
